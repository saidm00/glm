...
#define mod_vector        GLM_CALL_FUNC(mod_vector       , GLM_VEC_NAME(L, T, Q))
#define mod_scalar        GLM_CALL_FUNC(mod_scalar       , GLM_VEC_NAME(L, T, Q))
#define modf              GLM_CALL_FUNC(modf             , GLM_VEC_NAME(L, T, Q))
#define min_vector        GLM_CALL_FUNC(min_vector       , GLM_VEC_NAME(L, T, Q))
#define min_scalar        GLM_CALL_FUNC(min_scalar       , GLM_VEC_NAME(L, T, Q))
#define max_vector        GLM_CALL_FUNC(max_vector       , GLM_VEC_NAME(L, T, Q))
#define max_scalar        GLM_CALL_FUNC(max_scalar       , GLM_VEC_NAME(L, T, Q))
#define clamp_vector      GLM_CALL_FUNC(clamp_vector     , GLM_VEC_NAME(L, T, Q))
#define clamp_scalar      GLM_CALL_FUNC(clamp_scalar     , GLM_VEC_NAME(L, T, Q))
#define mix_vector        GLM_CALL_FUNC(mix_vector       , GLM_VEC_NAME(L, T, Q))
#define mix_scalar        GLM_CALL_FUNC(mix_scalar       , GLM_VEC_NAME(L, T, Q))
#define step_vector       GLM_CALL_FUNC(step_vector      , GLM_VEC_NAME(L, T, Q))
#define step_scalar       GLM_CALL_FUNC(step_scalar      , GLM_VEC_NAME(L, T, Q))
#define smoothstep_vector GLM_CALL_FUNC(smoothstep_vector, GLM_VEC_NAME(L, T, Q))
#define smoothstep_scalar GLM_CALL_FUNC(smoothstep_scalar, GLM_VEC_NAME(L, T, Q))
