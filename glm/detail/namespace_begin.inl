...
#define addeqs               GLM_CALL_FUNC(vec(L, T, Q), addeqs)
#define subeqs               GLM_CALL_FUNC(vec(L, T, Q), subeqs)
#define muleqs               GLM_CALL_FUNC(vec(L, T, Q), muleqs)
#define diveqs               GLM_CALL_FUNC(vec(L, T, Q), diveqs)
#define addeqv               GLM_CALL_FUNC(vec(L, T, Q), addeqv)
#define subeqv               GLM_CALL_FUNC(vec(L, T, Q), subeqv)
#define muleqv               GLM_CALL_FUNC(vec(L, T, Q), muleqv)
#define diveqv               GLM_CALL_FUNC(vec(L, T, Q), diveqv)
